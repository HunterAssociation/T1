...
async def MENU_H_page_2(m:Message):
    ...
    H12 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/ce42090f1dca6422a1e62.jpg", caption=message.M_G_12, parse_mode="html", reply_markup=inline.I_H_12)
    H13 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/f4fde9d9194b38a4ed509.jpg", caption=message.M_G_13, parse_mode="html", reply_markup=inline.I_H_13)
    H14 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/59c4b2ca5652e40d72d0f.jpg", caption=message.M_G_14, parse_mode="html", reply_markup=inline.I_H_14)
    H15 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/53f9d6e667f539ceee987.jpg", caption=message.M_G_15, parse_mode="html", reply_markup=inline.I_H_15)
    H16 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/1e6ce8165058c86db11ed.jpg", caption=message.M_G_16, parse_mode="html", reply_markup=inline.I_H_16)
    H17 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/63a444ade8ea5dcdcfcc6.jpg", caption=message.M_G_17, parse_mode="html", reply_markup=inline.I_H_17)
    H18 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/92a1a910052ca666971ca.jpg", caption=message.M_G_18, parse_mode="html", reply_markup=inline.I_H_18)
    H19 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/620377b345806f0add519.jpg", caption=message.M_G_19, parse_mode="html", reply_markup=inline.I_H_19)
    H20 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/36b1ee8b8fa9f14bf9fb9.jpg", caption=message.M_G_20, parse_mode="html", reply_markup=inline.I_H_20)
    await asyncio.sleep(300)
    await m.delete()
    await H11.delete()
    await H12.delete()
