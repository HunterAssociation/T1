...
#               M E N U - P               #
###########################################
@aio.message_handler(lambda message : message.text == 'ᴘ',state='*')
async def MENU_P(m:Message):
    P1 = await bot.send_message(m.chat.id, text=message.M_P_1, reply_markup=inline.K_END)
    P2 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/6841cbf15ec287e620388.jpg", caption=message.M_P_2, parse_mode="html", reply_markup=inline.I_P_2)
    P3 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/3e776a0ba5683b66827b1.jpg", caption=message.M_P_3, parse_mode="html", reply_markup=inline.I_P_3)
    P4 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/3e04f90962511c0bcee3b.jpg", caption=message.M_P_4, parse_mode="html", reply_markup=inline.I_P_4)
    P5 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/748bbb9ba1efb8e448b36.jpg", caption=message.M_P_5, parse_mode="html", reply_markup=inline.I_P_5)
    P6 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/f110921efe25a2e53b1d6.jpg", caption=message.M_P_6, parse_mode="html", reply_markup=inline.I_P_6)
    P7 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/321733402cbd32ae700d0.jpg", caption=message.M_P_7, parse_mode="html", reply_markup=inline.I_P_7)
    await asyncio.sleep(300)
    await m.delete()
    await P1.delete()
    await P2.delete()
...
async def MENU_W(m:Message):
    W1 = await bot.send_message(m.chat.id, text=message.M_W_1, reply_markup=inline.K_END)
    W2 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/3c2f3c4e52c90718717e8.jpg", caption=message.M_W_2, parse_mode="html", reply_markup=inline.I_W_2)
    W3 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/3d63aaac8b82e9ce27b5e.jpg", caption=message.M_W_3, parse_mode="html", reply_markup=inline.I_W_3)
    W4 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/750cd7d2dc3d991b46983.jpg", caption=message.M_W_4, parse_mode="html", reply_markup=inline.I_W_4)
    W5 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/a6952c1c1a483e44ddfea.jpg", caption=message.M_W_5, parse_mode="html", reply_markup=inline.I_W_5)
    await asyncio.sleep(300)
    await m.delete()
    await W1.delete()
    await W2.delete()
...
async def MENU_Y(m:Message):
    ...
    Y6 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/ec5b55bb211de665183c3.jpg", caption=message.M_Y_6, parse_mode="html", reply_markup=inline.I_Y_6)
    Y7 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/80ce8981c1ff5444b76a7.jpg", caption=message.M_Y_7, parse_mode="html", reply_markup=inline.I_Y_7)
    Y8 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/a4f7d4c9f0910108c1f89.jpg", caption=message.M_Y_8, parse_mode="html", reply_markup=inline.I_Y_8)
    Y9 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/6c47ebeafcb90fd8d6504.jpg", caption=message.M_Y_9, parse_mode="html", reply_markup=inline.I_Y_9)
    await asyncio.sleep(300)
    await m.delete()
    await Y1.delete()
    await Y2.delete()
...
#               M E N U - Z               #
###########################################
@aio.message_handler(lambda message : message.text == 'ᴢ',state='*')
async def MENU_Z(m:Message):
    Z1 = await bot.send_message(m.chat.id, text=message.M_Z_1, reply_markup=inline.K_END)
    Z2 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/fa50ac3fd392e37374ff3.jpg", caption=message.M_Z_2, parse_mode="html", reply_markup=inline.I_Z_2)
    Z3 = await bot.send_photo(m.chat.id, photo="https://telegra.ph/file/e20acb51af697c07eafac.jpg", caption=message.M_Z_3, parse_mode="html", reply_markup=inline.I_Z_3)
    await asyncio.sleep(300)
    await m.delete()
    await Z1.delete()
    await Z2.delete()
